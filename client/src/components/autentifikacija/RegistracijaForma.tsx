...
function RegistracijaForma() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="pt-[100px] flex justify-center mt-[60px]">
        <div className="bg-[#f3e5ff] shadow-md rounded-2xl p-10 w-full max-w-md border border-purple-400">
          
          {/* Korisničko ime */}
          <label className="block text-lg text-gray-800 mb-2">Korisničko ime:</label>
          <input
            type="text"
          ...
          {/* Lozinka */}
          <label className="block text-lg text-gray-800 mt-4 mb-2">Lozinka:</label>
          <input
            type="password"
            className="w-full px-4 bg-white py-2 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-purple-400"
          />

          {/* Uloga: Korisnik ili Moderator */}
          <label className="block text-lg text-gray-800 mt-4 mb-2">Uloga:</label>
          <select
            className="w-full px-4 py-2 bg-white rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-purple-400"
